...
#define MAKE_PORT(portName, ddrName, pinName, className, ID) \
    ...
    public:\
      ...
      static void Set(DataT value){portName.OUTSET = value;}\
      static void Clear(DataT value){portName.OUTCLR = value;}\
      static void Toggle(DataT value){portName.OUTTGL = value;}\
      static void DirSet(DataT value){portName.DIRSET = value;}\
      static void DirClear(DataT value){portName.DIRCLR = value;}\
      static void DirToggle(DataT value){portName.DIRTGL = value;}\
      static DataT PinRead(){return portName.IN;}\
      enum{Id = ID};\
